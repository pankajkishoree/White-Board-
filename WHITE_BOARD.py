...
# Setting the window size to match the screen
...
#icon
image_icon= PhotoImage(file="dfgh.png")
root.iconphoto(False,image_icon)

color_box= PhotoImage(file="color.png")
Label(root,image=color_box, bg= "#f2f3f5").place(x=10,y=20)

eraser= PhotoImage(file="download (1).png")
...
canvas= Canvas(root,width=1600, height=1000, background="white", cursor="hand2")
